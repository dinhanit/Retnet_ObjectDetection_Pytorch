...
####################################################################################
    ...
    def forward(self, x):
        ...
        x = self.detector(x).permute(0,2,3,1)
        # x = self.head(x)
        return x
####################################################################################

@register_model
def RMT_T(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
...
@register_model
def RMT_S(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
        embed_dims=[64, 128, 256, 512],
        depths=[3, 4, 18, 4],
        num_heads=[4, 4, 8, 16],
...
@register_model
def RMT_B(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
...
@register_model
def RMT_L(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
