...
class VisRetNet(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 layerscales=[False, False, False, False], layer_init_values=1e-6, token_label=True, **kwargs):
        super().__init__()
...
@register_model
def RMT_T_token_label(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
...
@register_model
def RMT_S_token_label(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
        embed_dims=[64, 128, 256, 512],
        depths=[3, 4, 18, 4],
        num_heads=[4, 4, 8, 16],
...
@register_model
def RMT_B_token_label(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
...
@register_model
def RMT_L_token_label(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VisRetNet(
...
if __name__ == '__main__':
    ...
    net = RMT_T_token_label(num_classes=5)
    print(net(torch.rand([1,3,224,224]))[1].shape)
